function Ret=main_alessio(X,y,Xtest,ytest)
...
% by Chu, Ghahramani, ICML, 2005
        ...
        opts.SE.l2 = 0.5*ones(size(X,2),1);   %length-scale square
        opts.SE.sigmaf2 = 1.0; %kernel variance
        opts.sigmae2 = 1.0; % noise variance
